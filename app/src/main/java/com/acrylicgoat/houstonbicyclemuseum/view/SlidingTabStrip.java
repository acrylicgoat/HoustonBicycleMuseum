...
class SlidingTabStrip extends LinearLayout
{
    ...
    private static final int DEFAULT_SELECTED_INDICATOR_COLOR = 0xFFfeac00;
    ...
    SlidingTabStrip(Context context, AttributeSet attrs)
    {
        ...
        defaultTabColorizer.setDividerColors(setColorAlpha(themeForegroundColor, DEFAULT_DIVIDER_COLOR_ALPHA));
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        for (int i = 0; i < childCount - 1; i++)
        {
            ...
            canvas.drawLine(child.getRight(), separatorTop, child.getRight(), separatorTop + dividerHeightPx, dividerPaint);
        }
    }
